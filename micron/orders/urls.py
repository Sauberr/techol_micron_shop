...
urlpatterns = [
    ...
    path(_('delete_orders/<int:order_id>/'), login_required(delete_order), name='delete_order'),
    path('detail_order/<int:order_id>/', login_required(detail_order), name='detail_order'),
